...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(Long id, String username, String email, String password, Long departementID,
	...
	public static UserDetailsImpl build(User user) {
		...
		if(role.equals("CHEF_DEPARTEMENT") ){
			...
			return new UserDetailsImpl(
					...
					user.getEmail(),
					user.getPassword(),
					((Enseignant) user).getDepartement().getId(),
					authorities);
		}else {
			return new UserDetailsImpl(
					user.getId(),
